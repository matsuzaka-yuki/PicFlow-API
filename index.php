...
<html>
	<head>
		...
		<title>随机二次元图片API - 有希API接口站</title>
	...
	<body>
		<div>
			<p algin=“center” class="title title2">随机二次元图片API - 有希API接口</p>
		</div>
		<div class="container">
			<div class="well">
				<p>目前系统共收录 1k+ 张图片 API最后更新时间:2025-01-1</p>
				<p>图片均为https，采用上海骨干服务器，高速访问</p>
				<p>自判断二次元API基本调用格式：</p>
				...
				<pre>json/images</pre>
				<p>有希日记</p>
				<pre><a href="https://www.mysqil.com" target="_blank">https://mysqil.com</a></pre>
			</div>
		</div>
		<div class="bottom">

                    <p>Copyright © 2025 <a href="https://api.ghser.com/" target="_blank" class="one-pan-link-mark">有希API接口</a></p>
		</div>
	</body>
</html>